	...
	<div class="row mb-2">
		...
		<div class="col-sm-6">
			<ol class="breadcrumb float-sm-right">
				...
				<li class="breadcrumb-item">
					<a href="{{ url('/page/admin/prodi/') }}"> Data Prodi </a>
				</li>
...
<div class="container-fluid">
	<div class="row">
		<div class="col-md-4">
			<form id="quickForm" method="POST" action="{{ url('/page/admin/prodi/simpan') }}">
				{{ csrf_field() }}
				<input type="hidden" name="id_prodi" value="{{ $edit->id_prodi }}">
				<div class="card">
					...
					<div class="card-body">
						<div class="form-group">
							...
							<input type="text" class="form-control" id="nama_prodi" name="nama_prodi" placeholder="Masukkan Nama Prodi" value="{{ $edit->nama_prodi }}">
						</div>
						<div class="form-group">
