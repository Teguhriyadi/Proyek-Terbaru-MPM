					...
					<table id="example1" class="table table-bordered table-striped">
						...
						<tbody>
							...
							<tr>
								...
								<td class="text-center">{{ $user->id_role }}</td>
								<td class="text-center">
									<button onclick="editAkun({{$user->id}})" type="button" class="btn btn-warning" data-toggle="modal" data-target="#modal-default-edit">
