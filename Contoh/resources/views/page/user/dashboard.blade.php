        ...
        <div class="container" data-aos="fade-up">
            ...
            <div class="row content">
                ...
                <div class="col-lg-6 pt-4 pt-lg-0">
                    ...
                    <a href="{{ url('/tentang_kami') }}" class="btn-learn-more">
                        Selengkapnya
                    </a>
                </div>
            </div>
    ...
    <section id="why-us" class="why-us section-bg">
        <div class="container-fluid" data-aos="fade-up">
            ...
            <div class="row">
                ...
                <div class="col-lg-5 align-items-stretch order-1 order-lg-2 img" style='background-image: url("{{ url('/template_user/template') }}/assets/img/why-us.png");' data-aos="zoom-in" data-aos-delay="150">&nbsp;</div>
            </div>
        ...
        <div class="container" data-aos="fade-up">
            ...
            <div class="row">
                ...
                <div class="col-lg-7 mt-5 mt-lg-0">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ url('/tambah_pesan') }}" method="post">
                                {{ csrf_field() }}
                                <div class="row">
